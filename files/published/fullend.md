...
> 5개 SSOT의 정합성을 한 번에 검증하고 코드를 산출하는 CLI.
...
OpenAPI, SQL DDL, Terraform은 업계 표준이다. 화면과 서비스 흐름은 해당하는 SSOT DSL이 없었다. 프론트엔드 결정은 React 훅에 매몰되고, 서비스 흐름은 Go 핸들러에 흩어졌다. 그래서 [STML](/dsl/stml/)과 [SSaC](/dsl/ssac/)를 설계했다. 이 프로젝트에서 만든 DSL이다.
...
MIT — [GitHub](https://github.com/geul-org/fullend)
