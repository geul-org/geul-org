...
嵌入相似度的结构性局限在[为什么嵌入向量行不通](/zh/why/not-embedding-vector/)中有更深入的探讨。
...
机械过滤的原理在[为什么机械校验是必要的](/zh/why/mechanical-verification/)中讨论，信息间矛盾检测在[为什么一致性检查是必要的](/zh/why/consistency-check/)中讨论。
...
这些条件具体如何实现，在[为什么需要语义对齐索引?](/zh/why/semantically-aligned-index/)中讨论。
...
自然语言的结构性缺陷为什么会产生幻觉，在[为什么自然语言会产生幻觉?](/zh/why/natural-language-hallucination/)中分析。
