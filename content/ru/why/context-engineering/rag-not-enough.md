...
Структурные ограничения эмбеддинг-сходства подробнее рассмотрены в [Почему эмбеддинг-векторов недостаточно](/ru/why/not-embedding-vector/).
...
Принципы механической фильтрации обсуждаются в [Почему необходима механическая верификация](/ru/why/mechanical-verification/), а обнаружение противоречий -- в [Почему необходимы проверки согласованности](/ru/why/consistency-check/).
...
Как эти условия конкретно реализуются, обсуждается в [Почему семантически выровненный индекс?](/ru/why/semantically-aligned-index/).
...
Почему структурные дефекты естественного языка создают галлюцинации, анализируется в [Почему естественный язык создаёт галлюцинации?](/ru/why/natural-language-hallucination/).
