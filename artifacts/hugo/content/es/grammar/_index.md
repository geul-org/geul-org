...
La gramática de GEUL (General Encoding Unified Language) es un formato de flujo binario basado en SIDX (Semantic-aligned Index), un identificador semántico global de 64 bits.
