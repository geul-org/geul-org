...
La grammaire GEUL (General Encoding Unified Language) est un format de flux binaire base sur SIDX (Semantic-aligned Index), un identifiant semantique global de 64 bits.
